...
.PHONY: all test clean t-m deploy fund help install snapshot format anvil 
...
# Target to run a specific test function
t-m:;
...
deploy:
	@forge script script/DeployDraw.s.sol:DeployDraw $(NETWORK_ARGS)
